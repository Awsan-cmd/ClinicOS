...
describe("Appointment Type API security boundary", () => {
  it("requires authentication", async () => {
    ...
    try {
      const response = await fetch(`${url}/api/v1/appointment-types`);
  ...
  it("denies appointment type listing without appointment_type:read", async () => {
  ...
  it("denies appointment type creation without appointment_type:manage", async () => {
  ...
  it("lists appointment types using the authenticated tenant and branch context", async () => {
  ...
  it("creates an appointment type and records the authenticated actor in the audit event", async () => {
    const pool = createAuthenticatedPool("admin");
  ...
  it("rejects duplicate appointment type code with conflict", async () => {
    const pool = createAuthenticatedPool("admin");
  ...
  it("rejects invalid appointment type input", async () => {
    const pool = createAuthenticatedPool("admin");
